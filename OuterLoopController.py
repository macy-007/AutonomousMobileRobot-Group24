...
class OuterLoopController:
    ...
    Responsible for generating desired global velocities and body-frame transformations.
    """
    def __init__(self):
    ...
    def compute_outer_loop(self, current_pos, target_pos, current_yaw, target_yaw,dt):
        ...
        # Calculate the desired velocity vector via PID formula
        ...
        return v_des_global, yaw_rate_cmd